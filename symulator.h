...
protected:
    ...
    SiecUAR *siecUAR = nullptr;      // ← dodane
    bool trybSieciowy = false;       // ← dodane
...
public:
    ...
    void symulacja();
    void setSiec(SiecUAR *siec);           // ← dodane
    void setTrybSieciowy(bool stan);       // ← dodane
